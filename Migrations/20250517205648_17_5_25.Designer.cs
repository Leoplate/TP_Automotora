...
namespace technical_tests_backend_ssr.Migrations
{
    ...
    [Migration("20250517205648_17_5_25")]
    partial class _17_5_25
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("technical_tests_backend_ssr.Models.Estado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("technical_tests_backend_ssr.Models.Posventa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("technical_tests_backend_ssr.Models.Tipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("technical_tests_backend_ssr.Models.Posventa", b =>
                {
                    ...
                    b.HasOne("technical_tests_backend_ssr.Models.Estado", "Estado")
                        .WithMany()
                        .HasForeignKey("Estadoid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("technical_tests_backend_ssr.Models.Tipo", "Tipo")
                        .WithMany()
